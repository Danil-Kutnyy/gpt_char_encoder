...
'''
	"train_loss_general_original": [],
	"val_loss_general:original": [],
...
for iter in range(max_iters):
	...
	optimizer_origina3l.zero_grad(set_to_none=True)
	...
	if (iter % eval_interval == 0) or iter == max_iters - 1:
		...
		print(f"step {iter}: "f"Original loss: {res['generic'][0]:.4f}; Char Encoder Add loss: {res['generic'][1]:.4f}")
		...
		training_data['loss']['val']['synthetic']['original'].append(0)
		training_data['loss']['val']['synthetic']['chars'].append(0)

		training_data['loss']['train']['generic']['original'].append(losses[0])
		training_data['loss']['train']['generic']['chars'].append(losses[1])
		training_data['loss']['train']['synthetic']['original'].append(0)
		training_data['loss']['train']['synthetic']['chars'].append(0)
